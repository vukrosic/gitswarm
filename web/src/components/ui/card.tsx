...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        'relative rounded-[var(--radius)] border border-border bg-gradient-to-b from-card/90 to-background/95 text-card-foreground shadow-[0_24px_70px_hsl(0_0%_0%/0.42)] backdrop-blur-xl',
        className,
      )}
      {...props}
    />
